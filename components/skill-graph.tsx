...
// 50,78 90,10 10,10
    return (
        <>        
<svg height="145" viewBox={`0 0 120 120`} xmlns="http://www.w3.org/2000/svg">
 ...
 /> */}
    ...
    <text x={edgePointA.x - 10}   y={edgePointA.y} fill="white"  className="text-[6px] font-extralight text-white">Acc</text>
    <text x={edgePointA.x - 20}   y={edgePointA.y + 10} fill="white" className="text-[6px] font-extralight text-white">{(factorA * 100).toFixed(2)}%</text>
    <text x={edgePointB.x }   y={edgePointB.y} fill="white" className="text-[6px] font-extralight text-white">Tech</text>
    <text x={edgePointB.x }   y={edgePointB.y + 10} fill="white" className="text-[6px] font-extralight text-white">{(factorB * 100).toFixed(2)}%</text>
    <text x={edgePointC.x - 6}   y={edgePointC.y + 6} fill="white" className="text-[6px] font-extralight text-white">Pass</text>
    <text x={edgePointC.x - 8}   y={edgePointC.y + 12} fill="white" className="text-[6px] font-extralight text-white">{(factorC * 100).toFixed(2)}%</text>
        {/* 数据点b */}
